using Binances.Helper.Models.Account;
...
namespace Binances.Helper.Domain.Interface
{
    public interface IBinanceClient
    {
        ...
        /// <returns></returns>
        Task<NewOrder> PostNewOrder(string symbol, decimal quantity, decimal price, OrderSide side, OrderType orderType = OrderType.LIMIT, string newClientOrderId = "", TimeInForce timeInForce = TimeInForce.GTC, decimal icebergQty = 0m, long recvWindow = 6000000);
