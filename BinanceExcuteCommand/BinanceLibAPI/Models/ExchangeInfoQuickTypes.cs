...
namespace BinanceLibAPI.TEST
{
    ...
    public partial class ExchangeInfoQuickTypes
    {
        public static ExchangeInfoQuickTypes FromJson(string json) => JsonConvert.DeserializeObject<ExchangeInfoQuickTypes>(json, BinanceLibAPI.TEST.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ExchangeInfoQuickTypes self) => JsonConvert.SerializeObject(self, BinanceLibAPI.TEST.Converter.Settings);
    }
